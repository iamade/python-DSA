...
should have the same number of elements on both sides, but it doesn't.
The slice a[::2] selects every second element of the list a, 
which results in a list of 5 elements: [1, 3, 5, 7, 9]. On the right side of the assignment, 
there are 6 elements: 10, 20, 30, 40, 50, 60. Since the number of elements is not equal, 
Python will raise a ValueError when executing this code:
